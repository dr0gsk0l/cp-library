...
data:
  ...
  bundledCode: "#line 2 \"library/formalpowerseries/Base.cpp\"\n#define REP_(i, n)\
    ...
    \ntemplate <typename FPS> class RationalSum {\n    std::queue<std::pair<FPS, FPS>>\
    \ que;\n\n  public:\n    void add(const FPS &f, const FPS &g) { que.emplace(f,\
    \ g); }\n    FPS sum() {\n        if (!que.size())\n            return FPS(0);\n\
...
layout: document
redirect_from:
- /library/library/formalpowerseries/RationalSum.cpp
- /library/library/formalpowerseries/RationalSum.cpp.html
