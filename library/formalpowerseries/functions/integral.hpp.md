...
data:
  ...
  bundledCode: "#line 1 \"library/util/Valarray.hpp\"\n#include <vector>\n#include\
    ...
    \ *= a)\n            res += at(i) * b;\n        return res;\n    }\n};\n#line\
    \ 3 \"library/formalpowerseries/functions/integral.hpp\"\n\nnamespace fps {\n\n\
...
layout: document
redirect_from:
- /library/library/formalpowerseries/functions/integral.hpp
- /library/library/formalpowerseries/functions/integral.hpp.html
