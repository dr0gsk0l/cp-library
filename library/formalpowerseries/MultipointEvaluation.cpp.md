...
data:
  ...
  bundledCode: "#line 2 \"library/formalpowerseries/Base.cpp\"\n#define REP_(i, n)\
    ...
    \  REVERSE_(f);\n  REVERSE_(g);\n  return {q,f-q*g};\n}\n#undef REVERSE_\n#line\
    \ 4 \"library/formalpowerseries/MultipointEvaluation.cpp\"\ntemplate <typename\
...
documentation_of: library/formalpowerseries/MultipointEvaluation.cpp
layout: document
redirect_from:
- /library/library/formalpowerseries/MultipointEvaluation.cpp
- /library/library/formalpowerseries/MultipointEvaluation.cpp.html
