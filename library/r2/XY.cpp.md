...
data:
  ...
  bundledCode: "#line 2 \"library/r2/XY.cpp\"\ntemplate <typename T> struct XY {\n\
    ...
    \           return {0, 1};\n        return {0, 0};\n    }\n};\n"
  code: "#pragma once\ntemplate <typename T> struct XY {\n    T x, y;\n    XY() =\
    \ default;\n    XY(T x, T y) : x(x), y(y) {}\n    XY(const pair<T, T> &xy) : x(xy.first),\
    ...
    \ operator*(const T &a, const XY &u) { return XY(u) *= a; }\n    friend XY operator/(const\
    \ XY &u, const T &a) { return XY(u) /= a; }\n\n    bool operator<(const XY &v)\
    \ const { return x != v.x ? x < v.x : y < v.y; }\n    bool operator>(const XY\
    \ &v) const { return x != v.x ? x > v.x : y > v.y; }\n    bool operator==(const\
    \ XY &v) const { return x == v.x and y == v.y; }\n    bool operator!=(const XY\
    \ &v) const { return !(*this == v); }\n\n    double arg() const { return atan2(y,\
    \ x); }\n\n    // [0,2pi) \u3067 \u03B8(u)<\u03B8(v) \u306E\u6642 true\n    //\
    \ (0,0) \u306F 2pi \u306B\u76F8\u5F53\n    // static bool angle_cmp(const XY&u,const\
