...
data:
  ...
  attributes:
    ...
    PROBLEM: https://judge.yosupo.jp/problem/substd::set_convolution
    links:
    - https://judge.yosupo.jp/problem/substd::set_convolution
  bundledCode: "#line 1 \"test/library-checker/Convolution/SubsetConvolution.test.cpp\"\
    ...
    \ b);\n    REP (i, N)\n        std::cout << c[i] << \"\\n \"[i + 1 < N];\n}\n"
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/substd::set_convolution\"\
    \n#include <bits/stdc++.h>\n\n#define REP(i, n) for (int i = 0; i < (n); i++)\n\
