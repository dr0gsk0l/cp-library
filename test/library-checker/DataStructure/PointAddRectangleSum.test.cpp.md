...
data:
  ...
  bundledCode: "#line 1 \"test/library-checker/DataStructure/PointAddRectangleSum.test.cpp\"\
    ...
    \ C.r(id); }\n  //[l,r) \u3092\u8FD4\u3059\n  pair<int,int> interval(const T&l,const\
    \ T&r){\n    if(C.max().x<l or r<=C.min().x)return make_pair(0,0);\n    T mn=numeric_limits<T>::min();\n\
    \    int L=C.geq(r2(l,mn));\n    int R=C.geq(r2(r,mn));\n    return make_pair(L,R);\n\
    \  }\n};\n#line 10 \"test/library-checker/DataStructure/PointAddRectangleSum.test.cpp\"\
